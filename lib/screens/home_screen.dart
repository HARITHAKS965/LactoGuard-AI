              ...
              children: [
                ScaleTransition(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsets.fromLTRB(isDesktop ? 28 : 18, 18, isDesktop ? 28 : 18, 22),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            user != null ? 'Welcome, ${user.displayName ?? user.email ?? 'User'}' : 'AI-Powered Milk Safety Dashboard',
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Works Offline & Live Sync', style: TextStyle(color: Color(0xFF2DC653), fontWeight: FontWeight.w800, fontSize: 13)),
                                  Text('Built for rural areas & multi-device sync', style: TextStyle(color: Color(0xFF2DC653), fontSize: 11)),
                                ],
                              ),
                            ),
                          ],
